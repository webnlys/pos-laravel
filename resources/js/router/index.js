...
const routes = [
    { path: '/login', name: 'login', component: () => import('../pages/Login.vue'), meta: { guest: true } },
    {
        ...
        children: [
            { path: '', redirect: { name: 'admin.quotations' } },
            ...
            { path: 'units', name: 'admin.units', component: () => import('../pages/admin/units/Index.vue') },
            { path: 'units/create', name: 'admin.units.create', component: () => import('../pages/admin/units/Form.vue') },
            { path: 'units/:id/edit', name: 'admin.units.edit', component: () => import('../pages/admin/units/Form.vue') },
            ...
            { path: 'customers/:id', name: 'admin.customers.show', component: () => import('../pages/admin/customers/Show.vue') },
            { path: 'quotations', name: 'admin.quotations', component: () => import('../pages/admin/quotations/Index.vue') },
            { path: 'quotations/create', name: 'admin.quotations.create', component: () => import('../pages/admin/quotations/Form.vue') },
            { path: 'quotations/:id/edit', name: 'admin.quotations.edit', component: () => import('../pages/admin/quotations/Form.vue') },
            ...
            { path: 'sales/:id', name: 'admin.sales.show', component: () => import('../pages/admin/sales/Show.vue') },
