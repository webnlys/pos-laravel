<template>
    <PageShell :title="id ? 'Edit payment' : 'Receive payment'">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <select v-model.number="form.customer_id" class="form-select" required>
                        ...
                        <option v-for="c in customers" :key="c.id" :value="c.id">{{ c.name }} (due {{ c.due }})</option>
                    </select>
                </div>
                <div class="col-md-6">
                    ...
                    <select v-model="form.sale_id" class="form-select">
                        ...
                        <option v-for="s in sales" :key="s.id" :value="s.id">{{ s.number }} — {{ s.total }}</option>
                    </select>
                </div>
                <div class="col-md-4">
