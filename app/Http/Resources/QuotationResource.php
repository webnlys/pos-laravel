...
class QuotationResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'overall_tax_id' => $this->overall_tax_id,
            'overall_tax_name' => $this->overall_tax_name,
            'overall_tax_rate_percent' => $this->overall_tax_rate_percent !== null ? (float) $this->overall_tax_rate_percent : null,
